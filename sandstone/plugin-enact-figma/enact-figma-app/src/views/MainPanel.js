...
const MainPanel = kind({
    ...
    render: (props) => (
        <Panel {...props}>
			...
			<Header subtitle='Subtitle' title='Header title' placeholder='Header title' style={{color: 'rgb(230, 230, 230)', position: 'absolute', top: ri.scaleToRem(0), left: ri.scaleToRem(0), width: ri.scaleToRem(3840), height: ri.scaleToRem(600)}} />
